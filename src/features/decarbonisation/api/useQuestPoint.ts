...
import { insertManyQuestPoint, insertManyQuestPointProps } from "./quest-point.repository";


export function useInsertManyQuestPoint() {
    const muteto = useMutation({
        mutationFn: (payload: insertManyQuestPointProps[]) => insertManyQuestPoint(payload),
